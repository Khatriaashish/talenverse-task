...
const FeatureComponent = () => {
    return (<div className="container px-4 py-5 text-secondary" id="featured-3">
        <h2 className="pb-2 text-center text-body-emphasis">Messaging for all</h2>
        ...
        <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
            <div className="feature col">
                <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3 p-2 rounded-circle">
